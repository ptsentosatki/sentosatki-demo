...
const ModalEditVideos = ({ isOpen, closeModal, toast, selectedVideoId, refreshVideos }) => {
    ...
    useEffect(() => {
        axios.get(`${apiDatabaseUrl}/api/gallery/videos/${selectedVideoId}`)
        .then((response) => {
            setTitle(response.data.title);
            setCategory(response.data.category)
            setVideoPreview(`${apiDatabaseUrl}/api/uploads/videos/${response.data.src}`);
        }).catch((error) => {
    ...
    if(user) {
        ...
        const handleSubmit = async (e) => {
            ...
            await axios.put(`${apiDatabaseUrl}/api/gallery/videos/edit/${selectedVideoId}`, formData, {
                headers: {
