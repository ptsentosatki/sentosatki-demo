...
const AddJobsSection = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${apiDatabaseUrl}/api/jobs/add`, formData, {
                headers: {
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex">
                            ...
                            <input type="number" name="gaji" value={jobData.gaji} onChange={handleJobChange} placeholder='Contoh: 27470'
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <button type="button" onClick={addTaskField} className="btn-add px-4 py-2 font-medium text-white bg-primary-400 border border-transparent rounded-md hover:bg-primary-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-400 transition duration-400 ease-in-out">
                            Tambah Kolum Tugas
                        </button>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <button type="button" onClick={addDocumentField} className="btn-add px-4 py-2 font-medium text-white bg-primary-400 border border-transparent rounded-md hover:bg-primary-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-400 transition duration-400 ease-in-out">
                            Tambah Kolum Dokumen
                        </button>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2 flex justify-end">
                        <button
                            ...
                            className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-primary-secondary-800 border border-transparent rounded-md hover:bg-primary-secondary-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-secondary-800 transition duration-400 ease-in-out"
                        >
                            {loadingSubmit ? (
